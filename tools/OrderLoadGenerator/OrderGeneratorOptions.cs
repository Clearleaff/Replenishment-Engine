...
public sealed class OrderGeneratorOptions
{
    ...
    [Range(0, 0.95)]
    public double WaveAmplitudeFraction { get; set; } = 0.5;

    [Range(1, 86_400)]
    public double WavePeriodSeconds { get; set; } = 120;

    [Range(0.01, 10_000)]
    public double MinimumRatePerSecond { get; set; } = 0.5;

    [Range(0.01, 10_000)]
    public double MaximumRatePerSecond { get; set; } = 30;
